...
<div id="box1">
<h1> Species Note Record</h1>
</br></br>
<form action="wsaddSpeciesnotes.php" method="post" onsubmit="return CF()">
<input type="hidden" name="OldNoteTypeCode" Value="$SpeciesCode"/>
...
<table>
<tr><td>Species Name:</td><td> <select name="SpeciesCode">$SelectionSpeciesName</select> </td></tr>
