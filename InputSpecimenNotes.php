...
<div id="box1">
<h1> Specimen Note Record</h1>
</br></br>
<form action="wsaddSpecimennotes.php" method="post" onsubmit="return CF()">
<input type="hidden" name="OldNoteTypeCode" Value="$SpecimenCode"/>
...
<table>
<tr><td>SpecimenCode:</td><td> <select name="SpecimenCode">$SelectionSpecimen</select></td></tr>
